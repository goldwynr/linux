...
struct iomap_read_folio_ops {
	 ...
	 */
	void (*submit_io)(struct inode *inode, const struct iomap *iomap, struct bio *bio);
...
struct iomap_writeback_ops {
	 ...
	 * conversions.
	 */
	int (*prepare_ioend)(struct iomap_writepage_ctx *wpc, struct iomap_ioend *ioend, int status);
